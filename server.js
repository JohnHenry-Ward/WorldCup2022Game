...
app.use((req, res, next) => {
    res.setHeader(
        ...
        "default-src 'self'; font-src 'self' 'unsafe-inline'; img-src 'self' data:; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; frame-src 'self' 'unsafe-inline'"
    );
    next();
});
